import{apiSafe as d,apiBust as E}from"../lib/api.js";import{escape as a}from"../lib/dom.js";import{toast as v}from"../lib/toast.js";const b={totalUnlocked:0,totalAvailable:0,completionPct:0,totalPoints:0,epicUnlocked:0,legendaryUnlocked:0,mythicUnlocked:0,lastUnlocked:null},T={com\u00FAn:"#9CA3AF",rara:"#3B82F6",\u00E9pica:"#A855F7",legendaria:"#F59E0B",m\u00EDtica:"#EF4444"},L={crecimiento:"\u{1F4C8}",engagement:"\u2764\uFE0F",contenido:"\u{1F3AC}",comunidad:"\u{1F4AC}",ventas:"\u{1F4B0}",rituales:"\u2600\uFE0F",maestr\u00EDa:"\u{1F396}\uFE0F",especiales:"\u2728","tiktok-crecimiento":"\u{1F3B5}","tiktok-engagement":"\u{1F495}","instagram-crecimiento":"\u{1F4F8}","instagram-engagement":"\u2764\uFE0F"};let c=null,$=!1;const A=(t,n)=>{const r=T[t.rarity]??"#9CA3AF",l=t.hidden&&!n;return`
