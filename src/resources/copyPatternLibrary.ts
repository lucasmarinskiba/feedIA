...
export const copyPatterns: CopyPattern[] = [
  // HOOK PATTERNS
  {
    ...
    examples: ['Desafío os límites', 'Desafío os límites das trilhas', 'Challenge yourself today'],
  ...
  },
  {
    ...
    examples: ['Frete grátis agora', "Grab it Before It's Gone", 'R$ 200,90 limitado'],
  ...
  },
  {
    ...
    examples: ['Pedale ao lado de quem você ama', 'Explore the world on a bike', 'Vive la adventure'],
  ...
  // EDUCATION PATTERNS
  {
    ...
    examples: ['4 beneficios de usar bicicleta', '7 razones para cambiar', '5 tips para mejorar'],
  ...
  // SOCIAL PROOF PATTERNS
  {
    ...
    examples: ['Faça como a Rebeca e adquira sua bike', 'Join thousands who discovered this'],
  ...
  // CTA PATTERNS
  {
    ...
    examples: ['Explore más, vá de bike', 'Adquira su bike', 'Descubre el mundo', 'Contáctanos hoy'],
  ...
  },
  {
    ...
    examples: ['R$ 2.379,00 | Limitado', 'R$ 200,90 | Antes de que termine', 'From $199 | Limited time only'],
  ...
  },
  {
    ...
    examples: ['30 MINUTES A DAY WILL REPLACE:\n• Jogging for 2 hours\n• Swimming for 1 hour\n• Cycling 3 kilometers'],
  ...
  },
  {
    ...
    examples: ['TRAIN TOGETHER WIN TOGETHER', 'Grow together, achieve together', 'Community over isolation'],
  ...
  },
  {
    ...
    examples: ['Maximize seu faturamento', 'Recupere seus impostos', 'Proteja seu patrimônio', 'Reduza seus custos'],
  ...
  },
  {
    ...
    psychology:
      'Emotional root cause identification, repositioning problem, trust building (company understands real issue)',
  ...
  },
  {
    ...
    psychology:
      'Directly challenges false beliefs, provides proof of reality, positions company as solution specialist',
  ...
  },
  {
    ...
    tone: 'formal',
    template:
      'O seu [FAMILIAR_ENTITY/PERSON] te ensinou tudo que você precisa saber sobre [COMPLEX_CONCEPT].\n\n[EXPLANATION of how familiar entity demonstrates the principle]',
    examples: [
...
export const findCopyPattern = (criteria: { type?: string; tone?: string; industry?: string }): CopyPattern[] =>
  copyPatterns.filter((p) => {
