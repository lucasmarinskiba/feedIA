...
export const BOTS: readonly BotDefinition[] = [
  {
    ...
    costly: true,
    defaultEnabled: true,
    views: ['inbox', 'community', 'crisis', 'home', 'feed'],
  },
  {
    id: 'dm-bot',
    label: 'DMs e inbox',
  ...
  },
  {
    ...
    costly: true,
    defaultEnabled: true,
    views: ['studiotiktok', 'studiotiktokscript', 'studiotiktokphoto'],
  },
  {
    id: 'computer-use-bot',
    label: 'Computer Use',
    ...
    costly: true,
    defaultEnabled: true,
    views: ['pantalla', 'replay', 'vision', 'visión', 'studiomanager', 'canvarunner', 'handsfree'],
  },
  {
    id: 'ads-bot',
